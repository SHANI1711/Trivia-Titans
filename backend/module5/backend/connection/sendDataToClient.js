...
gamePlayedTimes++
  ...
  function sendEveryQuestion(ms,body,client) {
    ...
    await timeout(ms,value,client,playersOnlinelist,dataFromGetSendDataRequestFromClient,gamePlayedTimes)
  ...
  await sendEveryQuestion(5000,body,client);
  ...
  function timeout(ms,value,client,playersOnlinelist,dataFromGetSendDataRequestFromClient,gamePlayedTimes) {
  ...
  console.log("error getting the score inside seding data",err);
        ...
        for(const playerConnectedId of playersOnlinelist){
          ...
          const value1 = [value,{"connectionId":playerConnectedId.connectionId,"gamePlayedTimes":gamePlayedTimes,"playerScoreList":playerScoreJson}];
